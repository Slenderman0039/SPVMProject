...
public class DashboardAdmin {
    ...
    @FXML
    protected void onListaImpiegati() throws IOException {
        lista_impiegati_admin.VisualizzaImpiegati(title,stackpane);
    }
    @FXML
    protected void onListaStipendi() throws IOException {
        lista_stipendi_admin.VisualizzaStipendi(title,stackpane);
    }
    @FXML
    protected void onInserisciPermesso() throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/it/spvm/progetto_2022_2023_fx/admin/pane_inserisci_permesso.fxml"));
        Parent parent = fxmlLoader.load();
        title.setText("Inserisci permesso");
        stackpane.getChildren().set(0,parent);
        for(Node n: getAllNodes(parent)){
    ...
    @FXML
    protected void oninserisciRitardo() throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/it/spvm/progetto_2022_2023_fx/admin/pane_inserisci_ritardo.fxml"));
        Parent parent = fxmlLoader.load();
        title.setText("Inserisci ritardo");
        stackpane.getChildren().set(0,parent);
    }
    @FXML
    protected void onAssumiImpiegato() throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/it/spvm/progetto_2022_2023_fx/admin/pane_assumi_impiegato.fxml"));
        Parent parent = fxmlLoader.load();
        title.setText("Assumi Impiegato");
        stackpane.getChildren().set(0,parent);
    }
    @FXML
    protected void onLicenziaImpiegato() throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/it/spvm/progetto_2022_2023_fx/admin/pane_licenzia_impiegato.fxml"));
        Parent parent = fxmlLoader.load();
        title.setText("Licenzia Impiegato");
        stackpane.getChildren().set(0,parent);
        AdminController.VisualizzaImpiegatiLicenziamento(parent);
    }
    @FXML
    protected void onIncrementoAttivita() throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/it/spvm/progetto_2022_2023_fx/admin/pane_incremento_attivita.fxml"));
        Parent parent = fxmlLoader.load();
        title.setText("Incremento attività");
        stackpane.getChildren().set(0,parent);
    }
